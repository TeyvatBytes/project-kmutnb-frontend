...
<div class="flex flex-col gap-5 mt-5">
    ...
    <!-- Orders table -->
    <div class="bg-background rounded-lg shadow border overflow-hidden">
        {#if filteredOrders.length > 0}
...
<Modal bind:open={showOrderDetailsModal} class="p-8 max-w-3xl">
    {#if currentOrder}
        ...
        <div class="bg-background border border-gray-200 rounded-md mb-6">
            <div class="grid grid-cols-3 p-4 border-b">
                <div class="col-span-2">
                    ...
                    <p class="text-sm text-muted-foreground">
                        {currentOrder.product_description}
                    </p>
                </div>
        ...
        <div class="bg-muted p-4 rounded-md border border-gray-200 mb-6">
            <pre
